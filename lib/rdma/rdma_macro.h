...
#define SEND_COMPLETION_QUEUE_LENGTH 128
#define RECV_COMPLETION_QUEUE_LENGTH 128
#define SHARED_RECV_QUEUE_LENGTH 128
#define MAX_NUMBER_OF_OUTSTANDING_REQUESTS 16
#define MAX_NUMBER_OF_SGE_ELEMENTS 1
#define MAX_NUMBER_OF_WORKER_COMPLETION_QUEUE_LENGTH 128
