...
namespace faas::worker_cpp {
    ...
    private:
        ...
        char *buf_for_send_req_;
        char *buf_for_recv_req_;
        ...
        AllocMRInfo PostRecvRequest(std::string_view guid_name, const char **data, size_t *data_size);

        void PostSendRequest(std::string_view guid_name, const char **data, size_t *data_size);
